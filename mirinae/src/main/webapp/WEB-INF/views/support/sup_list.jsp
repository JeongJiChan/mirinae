	...
	<div>
		<table id="table">
			<c:forEach var="list" items="${sp_list }">
				<tr><th colspan="2"><img id="image" src="/mirinae/p_images/${list.p_no }.jpg"></th></tr>
				<tr><th>목표금액 : ${list.goal_money }</th><th>현재금액 : ${list.cur_money }</th></tr>
				...
				<tr><th>후원번호 : ${list.sup_no }</th><th id="s_subject">프로젝트 : ${list.p_name }</th></tr>
				<tr><th>후원일 : ${list.sup_date }</th><th>후원금액 : ${list.total_price }</th></tr>	
			</c:forEach>
		</table>
	</div>
