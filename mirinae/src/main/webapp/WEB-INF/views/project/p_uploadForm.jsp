...
<table id="picture_table">
	...
	<tr><td><input type='file' id="filename" name="filename" class="form-control"></td></tr>
</table>
<table id="project_table">
	...
	<tr><th class="topTable">프로젝트 기간</th><td><input type="date" id="s_date" name="s_date" required="required" class="form-controllogin"> ~ 
									<input type="date" name="e_date" required="required" class="form-controllogin"></td></tr>	
									
	<tr><th class="topTable">목표 금액</th><td><input type="number" name="goal_money" required="required" min="1" class="form-controllogin">원</td></tr>	
...
<textarea id="content" class="form-control" rows="20" style="width:99.5%;" placeholder="내용을 입력하세요" name="content" required="required"></textarea>
</div>
</div>
<div align="center" id="button"><input type="submit" value="등록" class="btn btn-primary optmargin"> <input type="button" value="취소" onclick="history.back()" class="btn btn-primary optmargin"></div>
</form>
</body>
</html>